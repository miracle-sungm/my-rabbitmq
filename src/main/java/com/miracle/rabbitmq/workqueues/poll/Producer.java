...
public class Producer {
    ...
    static final String EXCHANGE_NAME = "poll_work_queue_exchange";
    static final String QUEUE_NAME = "poll_work_queue";
    static final String ROUTING_KEY = "poll_work_routing_key";
